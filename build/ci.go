...
import (
	...
	"github.com/bisoncraft/op-geth/crypto/signify"
	"github.com/bisoncraft/op-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/bisoncraft/op-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/bisoncraft/op-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/bisoncraft/op-geth/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/bisoncraft/op-geth/core/rawdb", "github.com/bisoncraft/op-geth/ethdb/leveldb"},
		{"github.com/bisoncraft/op-geth/core/rawdb", "github.com/bisoncraft/op-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
